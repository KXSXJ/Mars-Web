    ...
    return(
        <div className="Background_Container">
            ...
            <div className="left_contents">
                ...
                <Link to="/Main1"><button id="Go_To_BARTENDER">조주기능사<img id="Arrow_Right"src="./start_page_img/Arrow_Right.png" alt="Arrow_Right"></img></button></Link>
                <button id="Go_To_BAKER">제과 · 제빵기능사<img id="Arrow_Right"src="./start_page_img/Arrow_Right.png"  alt="Arrow_Right"></img></button>
                </div>
