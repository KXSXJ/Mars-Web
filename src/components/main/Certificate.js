     ...
     <div className="Certificate_container">
        ...
        <div className="Video_img_contaioner">
            <div className="img_wrap">
                <img id="my_Certificate1"src="./Main_cocktail/certificate_img/My_Certificate1.png" alt="Certificate_img"></img>
            </div>
            <div className="img_wrap">
                <img id="my_Certificate2"src="./Main_cocktail/certificate_img/My_Certificate2.png" alt="Certificate_img"></img>
            </div>
        </div>
